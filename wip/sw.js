const CACHE='mesh-line-replacer-v0.8.9-wip.2';
const APP_SHELL=[
  ...
  './app-v087-static/grouped-instances.txt','./app-v088-static/view-modes.txt','./app-v089-static/instance-density.txt','./app-v089-static/density-v2-override.txt'
];
