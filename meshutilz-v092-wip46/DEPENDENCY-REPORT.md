# MeshUtilz WIP46 dependency and exclusion report

WIP46 is a grouping-only successor to the validated WIP45 export-authority build. It does not change the scatter, placement, orientation, density, Torus adapter, or Tube localisation algorithms. Its only intended NOM-data difference is one native group node containing all procedural placement nodes.
...
| `live-nom-import-mu092wip15.txt` | Required importer/UI base | Creates the Live NOM controls and base parser lifecycle. Its legacy export control is hidden by WIP46. |
...
| `live-nom-grouped-authority-mu092wip46.txt` | Sole visible exporter | Validates, stages, and downloads through `window.__muW46`. |
...
- WIP40–WIP45: rollback/reference exporters; no fallback is loaded.
