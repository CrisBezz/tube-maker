# MeshUtilz WIP48 dependency and exclusion report

WIP48 adds a procedural Box pass-through adapter to the validated WIP47 architecture. It does not change the scatter, placement, orientation, density, grouping, Torus adapter, or Tube localisation algorithms.
...
| `live-nom-support-mu092wip48.txt` | Required importer and bridge | Owns Tube/Torus/Box parsing, cached-geometry bridging, and authoritative transform capture without any exporter or `Blob` interception. |
...
| `live-nom-grouped-authority-mu092wip48.txt` | Sole visible exporter | Validates, stages, and downloads through `window.__muW48`. |
...
- WIP21: mixed Torus importer and obsolete competing exporter; its required parser behavior is consolidated into WIP48 support.
- WIP22: superseded authority/export interception.
- WIP23: mixed bridge and export interception; its required bridge/capture behavior is consolidated into WIP48 support.
- WIP26 and WIP31: obsolete competing exporters.
- WIP33: diagnostic-only UI.
- WIP40–WIP47: rollback/reference exporters; no fallback is loaded.
...
4. Stale stage: validate, change density or regenerate, confirm Download disables, validate again, and confirm the new node count/signature.
