# MeshUtilz v0.9.2 RC2.2.2 — verified native Tube-cache release candidate

RC2.2.2 promotes the WIP103 verified-cache gate. WIP86, WIP101, WIP102, WIP103, and all historical builds remain untouched.

## Verified safe path

RC2.2.2 retains exact native Nomad templates for 4×6, 6×6, 8×8, 10×6, 12×6, 14×6, and 6×12. Every selected template is checked for the Nomad Sculpt header and its pinned SHA-256 checksum before it can become the active Tube master.
